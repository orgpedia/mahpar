...
import/websites/gr.maharashtra.gov.in/Parliamentary:
	cd import/websites/gr.maharashtra.gov.in/ && ln -s $(GR_DIR)/Parliamentary .
...
import: check_env import/websites/gr.maharashtra.gov.in/Parliamentary .secrets/google.token 
	poetry run python import/src/build_documents.py import/websites/gr.maharashtra.gov.in/Parliamentary import/documents
